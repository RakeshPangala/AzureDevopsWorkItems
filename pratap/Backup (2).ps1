...
#virtual Network
New-AzureRmVm -ResourceGroupName $RGname -Location $location -Name prataprg

#Recovery Services Vault 
New-AzureRmRecoveryServicesVault -Name "pratapsv" -ResourceGroupName $RGname -Location $location
$vault= Get-AzureRmRecoveryServicesVault -Name "pratapRSG"
