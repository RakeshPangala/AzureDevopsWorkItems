...
$rule2=Get-AzNetworkSecurityGroup -Name "FrontendNSG" -ResourceGroupName "tej" | Add-AzNetworkSecurityRuleConfig -Name "Http-Rule" -Description "Allow RDP" -Access "Allow" -Protocol "Tcp" -Direction "Inbound" -Priority 101 -SourceAddressPrefix "Internet" -SourcePortRange "*" -DestinationAddressPrefix "*" -DestinationPortRange "80" | Set-AzNetworkSecurityGroup

$rule3=Get-AzNetworkSecurityGroup -Name "FrontendNSG" -ResourceGroupName "tej" | Add-AzNetworkSecurityRuleConfig -Name "Https-Rule" -Description "Allow RDP" -Access "Allow" -Protocol "Tcp" -Direction "Inbound" -Priority 102 -SourceAddressPrefix "Internet" -SourcePortRange "*" -DestinationAddressPrefix "*" -DestinationPortRange "443" | Set-AzNetworkSecurityGroup

$rule4=Get-AzNetworkSecurityGroup -Name "FrontendNSG" -ResourceGroupName "tej" | Add-AzNetworkSecurityRuleConfig -Name "SSH-Rule" -Description "Allow RDP" -Access "Allow" -Protocol "Tcp" -Direction "Inbound" -Priority 103 -SourceAddressPrefix "Internet" -SourcePortRange "*" -DestinationAddressPrefix "*" -DestinationPortRange "22" | Set-AzNetworkSecurityGroup
...
$ruleGet=AzNetworkSecurityGroup -Name "BackendNSG" -ResourceGroupName "tej" | Add-AzNetworkSecurityRuleConfig -Name "Http-Rule" -Description "Allow RDP" -Access "Deny" -Protocol "Tcp" -Direction "Outbound" -Priority 102 -SourceAddressPrefix "Internet" -SourcePortRange "*" -DestinationAddressPrefix "*" -DestinationPortRange "80" | Set-AzNetworkSecurityGroup
