...
$Tmprofile = New-AzureRmTrafficManagerProfile -Name AnnuTMPer -ResourceGroupName $rgname -TrafficRoutingMethod Performance -RelativeDnsName annuDns -Ttl 30 -MonitorProtocol HTTP -MonitorPort 80 -MonitorPath "/"

#------------Retrieve an existing Traffic Manager profile object

$TmProfile = Get-AzureRmTrafficManagerProfile -Name AnnuTMPer -ResourceGroupName $rgname
