...
$RG=New-AzureRmResourceGroup -Name "AnnuRG" -Location "East Us"
...
$nsg= New-AzureRmNetworkSecurityGroup  -ResourceGroupName "AnnuRG"  -Location "East Us" -Name AnnuNSG -SecurityRules $rule1,$rule2,$rule3
...
$nsg= New-AzureRmNetworkSecurityGroup  -ResourceGroupName "AnnuRG"  -Location "East Us" -Name AnnuNSG -SecurityRules $rule4,$rule5
