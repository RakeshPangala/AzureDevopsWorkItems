...
#----Creating Recovery Services Vault-------- 
    ...
    New-AzureRmRecoveryServicesVault -Name "AnnuRSG" -ResourceGroupName $rgname -Location $loc

    $vault= Get-AzureRmRecoveryServicesVault -Name "AnnuRSG"
...
New-AzureRmRecoveryServicesBackupProtectionPolicy -Name "AnnuPolicy" -WorkloadType "AzureVM" -RetentionPolicy $retPol -SchedulePolicy $schPol