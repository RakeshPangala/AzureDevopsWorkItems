...
New-AzureRmVm -ResourceGroupName $rgname -Location $loc -Name RakeshVM
...
#----Creating Recovery Services Vault-------- 
    ...
    New-AzureRmRecoveryServicesVault -Name "RakeshRSG" -ResourceGroupName $rgname -Location $loc



    $vault= Get-AzureRmRecoveryServicesVault -Name "RakeshRSG"
...
New-AzureRmRecoveryServicesBackupProtectionPolicy -Name "RakeshPolicy" -WorkloadType "AzureVM" -RetentionPolicy $retPol -SchedulePolicy $schPol

#starting a backup job

$backupcontainer = Get-AzRecoveryServicesBackupContainer 
    -ContainerType "AzureVM"
    -FriendlyName "RakeshVM"
