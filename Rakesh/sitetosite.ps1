...
$LocalNetworkGatewayName = 'RakeshLNGW'
...
$AzureVirtualGatewayName = 'RakeshVnetGW'
...
$SharedKey = 'Rakesh123' #The value here must match the value that you are using for your VPN device
