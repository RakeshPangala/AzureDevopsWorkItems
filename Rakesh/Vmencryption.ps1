...
$aadSvcPrinAppHomePage = 'http://thisisjusttestingurl'
...
$aadSvcPrinAppPassword = ConvertTo-SecureString 'Rakesh@123' -AsPlainText -Force
...
$resourceGroupName = 'RakeshRG'



$keyVaultName = 'RakeshKV'
...
$aadSvcPrinAppPassword = ConvertTo-SecureString 'Test@123' -AsPlainText -Force
