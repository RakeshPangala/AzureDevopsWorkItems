...
$RG=New-AzureRmResourceGroup -Name "SuryaRG" -Location "East Us"

#creating Virtual Network


$VN=New-AzureRmVirtualNetwork -ResourceGroupName "SuryaRG" -Location "East Us" -Name "SuryaVnet" -AddressPrefix "198.162.1.0/25"
...
$nsg= New-AzureRmNetworkSecurityGroup  -ResourceGroupName "SuryaRG"  -Location "East Us" -Name SuryaNSG -SecurityRules $rule1,$rule2,$rule3
...
$nsg= New-AzureRmNetworkSecurityGroup  -ResourceGroupName "SuryaRG"  -Location "East Us" -Name SuryaNSG -SecurityRules $rule4,$rule5