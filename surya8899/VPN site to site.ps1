...
$VMSubnetName = 'SuryaSubnet'
$VMAdressPrefix = '192.168.11.0/24'
 
#Public IP Address
$PublicIPGatewayName = 'SuryaPIP'
$IpAllocation = 'Dynamic'   #Dynamic,Static
 
#Local Network Gateway
$LocalNetworkGatewayName = 'SuryaLNGW'
...
$AzureVirtualGatewayName = 'SuryaVnetGW'
...
$SharedKey = 'Surya123' #The value here must match the value that you are using for your VPN device
