...
$password=ConvertTo -SecurityString "*******" -AsPlainText -Force
$AzureCred=New-Object System.Management.Automation.PsContainer($username,$password)-Credential $AzureCred
...
$nsgfe = New-AzureRmNetworkSecurityGroup -ResourceGroupName "SuryaRG" -Location "South india"  -Name FrontendsubnetNSG -SecurityRules $rule1,$rule2, $rule3
...
$nsgfe = New-AzureRmNetworkSecurityGroup -ResourceGroupName "SuryaRG" -Location "South india"  -Name BackendsubnetNSG -SecurityRules $rule1,$rule2, $rule3
