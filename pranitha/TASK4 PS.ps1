...
Install-Module -Name Az -Allow Clobber
...
$aadSvcPrinAppPassword = ConvertTo-SecureString 'pranitha@123' -AsPlainText -Force
...
2 - Allow the Azure Backup Service permission to the key vault.
