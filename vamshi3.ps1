...
$Rg= New-AzResourceGroup -Name vamshi -Location 'South India
...
$VNet1=New-AzVirtualNetwork -Name VNet1 -ResourceGroupName vamshi -Location southindia -AddressPrefix "194.168.1.0/24" -Subnet $feSubnet1,$beSubnet1,$gwsubnet1
...
$Vnet2=New-AzVirtualNetwork -Name VNet2 -ResourceGroupName vamshi -Location southindia -AddressPrefix "194.168.2.0/24" -Subnet $feSubnet2,$beSubnet2,$gwsubnet2
...
$Vnet3=New-AzVirtualNetwork -Name VNet3 -ResourceGroupName vamshi -Location southindia -AddressPrefix "194.168.3.0/24" -Subnet $feSubnet3,$beSubnet3,$gwsubnet3
...
$gwpip    = New-AzPublicIpAddress -Name Gw1PublicIP -ResourceGroupName vamshi -Location southindia -AllocationMethod Dynamic
...
$gwpip2    = New-AzPublicIpAddress -Name Gw2PublicIP -ResourceGroupName vamshi -Location southindia -AllocationMethod Dynamic
...
$Gw1=New-AzVirtualNetworkGateway -Name $Gw2 -ResourceGroupName vamshi -Location 'South India' -IpConfigurations $gwipconf2 -GatewayType Vpn -VpnType RouteBased -GatewaySku VpnGw1 
