...
$Tmprofile = New-AzureRmTrafficManagerProfile -Name gopalTMPer -ResourceGroupName $rgname -TrafficRoutingMethod Performance -RelativeDnsName gopalDns -Ttl 30 -MonitorProtocol HTTP -MonitorPort 80 -MonitorPath "/"

#Retrieve an existing Traffic Manager profile object

$TmProfile = Get-AzureRmTrafficManagerProfile -Name gopalTMPer -ResourceGroupName $rgname
...
#Creating traffic manager profile having Routing Method as priorit

$TmprofilePri = New-AzureRmTrafficManagerProfile -Name gopalTMPrio -ResourceGroupName $rgname -TrafficRoutingMethod Priority -RelativeDnsName gopalDns -Ttl 30 -MonitorProtocol HTTPS -MonitorPort 22 -MonitorPath "/"
...
$TmprofileWeig = New-AzureRmTrafficManagerProfile -Name gopalTMWeig -ResourceGroupName $rgname -TrafficRoutingMethod Weighted -RelativeDnsName gopaldns -Ttl 30 -MonitorProtocol HTTP -MonitorPort 80 -MonitorPath "/"
