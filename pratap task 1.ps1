...
$rm=New-AzureRmResourceGroup -Name 'prataprg'  -Location 'East US' 
$vn=New-AzureRmVirtualNetwork -Name 'pratapvnet' -ResourceGroupName 'prataprg'  -AddressPrefix 193.163.1.0/24 -Location 'East US'
...
Add-AzureRmVirtualNetworkSubnetConfig -Name 'sub2' -VirtualNetwork $vn -AddressPrefix 193.163.1.16/28
   $nsfront=New-AzureRmNetworkSecurityGroup -Name 'nsgfront' -ResourceGroupName 'prataprg' -Location 'East US' 
