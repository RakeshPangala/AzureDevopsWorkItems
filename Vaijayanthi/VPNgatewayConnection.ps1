...
$VMSubnetName = 'VaijayanthiSubnet'
$VMAdressPrefix = '192.168.11.0/24'
 
#Public IP Address
$PublicIPGatewayName = 'VaijayanthiPIP'
$IpAllocation = 'Dynamic'   #Dynamic,Static
 
#Local Network Gateway
$LocalNetworkGatewayName = 'VaijayanthiLNGW'
...
$AzureVirtualGatewayName = 'VaijayanthiVnetGW'
...
$SharedKey = 'Vaijayanthi123' #The value here must match the value that you are using for your VPN device
