...
New-AzureRmVm -ResourceGroupName $rgname -Location $loc -Name kpvm

#----Creating Recovery Services Vault-------- 



    New-AzureRmRecoveryServicesVault -Name "kpRSG" -ResourceGroupName $rgname -Location $loc



    $vault= Get-AzureRmRecoveryServicesVault -Name "kpRSG"
...
New-AzureRmRecoveryServicesBackupProtectionPolicy -Name "GowthamiPolicy" -WorkloadType "AzureVM" -RetentionPolicy $retPol -SchedulePolicy $schPol