...
$Tmprofile = New-AzureRmTrafficManagerProfile -Name kpTMPer -ResourceGroupName $rgname -TrafficRoutingMethod Performance -RelativeDnsName kpDns -Ttl 30 -MonitorProtocol HTTP -MonitorPort 80 -MonitorPath "/"
...
$TmProfile = Get-AzureRmTrafficManagerProfile -Name kpTMPer -ResourceGroupName $rgname
...
$TmprofilePri = New-AzureRmTrafficManagerProfile -Name kpTMPrio -ResourceGroupName $rgname -TrafficRoutingMethod Priority -RelativeDnsName GowthamiDns -Ttl 30 -MonitorProtocol HTTPS -MonitorPort 22 -MonitorPath "/"
...
$TmprofileWeig = New-AzureRmTrafficManagerProfile -Name kpTMWeig -ResourceGroupName $rgname -TrafficRoutingMethod Weighted -RelativeDnsName kpdns -Ttl 30 -MonitorProtocol HTTP -MonitorPort 80 -MonitorPath "/"
