...
#Virtual Network
$VirtualNetworkName = 'GowthamiVnet'
$VirtualNetworkAddressPrefix = '193.168.0.0/16' 
 
#Subnets
$GatewaySubnetName = 'GatewaySubnet'
$GatewayAdressPrefix = '193.168.0.0/27' 
 
$VMSubnetName = 'GowthamiSubnet'
$VMAdressPrefix = '193.168.11.0/24'
 
#Public IP Address
$PublicIPGatewayName = 'GowthamiPIP'
$IpAllocation = 'Dynamic'   #Dynamic,Static
 
#Local Network Gateway
$LocalNetworkGatewayName = 'GowthamiLNGW'
...
$AzureVirtualGatewayName = 'GowthamiVnetGW'
