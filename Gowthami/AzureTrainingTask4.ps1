...
$aadSvcPrinAppPassword = ConvertTo-SecureString 'Gmpol@123' -AsPlainText -Force
...
$resourceGroupName = 'GowthamiRG'
$aadSvcPrinAppDisplayName = 'VMEncryptionSvcPrincipalName'
$keyVaultName = 'GowthamiRGKeyVault'
